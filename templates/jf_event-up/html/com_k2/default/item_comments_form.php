...
<form action="<?php echo JURI::root(true); ?>/index.php" method="post" id="comment-form" class="form-validate">
	<div class="comment-form-left">
		<label class="formName" for="userName"><span class="red">*</span><?php echo JText::_('K2_NAME'); ?></label>
		...
		<label class="formEmail" for="commentEmail"><span class="red">*</span><?php echo JText::_('K2_EMAIL'); ?></label>
	...
	<div class="comment-form-right">
		<label class="formComment" for="commentText"><span class="red">*</span><?php echo JText::_('K2_MESSAGE'); ?></label>
