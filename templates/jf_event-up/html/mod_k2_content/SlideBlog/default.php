...
$siteUrl = JURI::root();
$tempPath = 'templates/jf_event-up/';
$document = JFactory::getDocument();
$document->addScript($siteUrl.$tempPath . 'scripts/js/jquery.jcarousel.js');
?>

<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlockSlideBlog<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
      ...
      <?php if($params->get('itemAuthor')): ?>
		...
		<?php if($params->get('itemDateCreated')): ?>
		  <span class="moduleItemDateCreated">
			...
			<?php echo JText::_('K2_POSTED_ON') ; ?> <?php echo JHTML::_('date', $item->created, JText::_('K2_DATE_FORMAT_LC5')); ?>
		  </span>
		<?php endif; ?>
  ...
  <?php endif; ?>
	...
	<?php if(count($items) || $params->get('itemCustomLink')): ?>
